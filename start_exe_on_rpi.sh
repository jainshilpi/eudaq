...
(ssh -T pi4 "sudo killall new_rdout.exe"; ssh -T pi4 "nohup sudo /home/pi/RDOUT_BOARD_IPBus/rdout_software/bin/new_rdout.exe 200 2000000 0 > log.log 2>&1 &"; ssh -T pi4 "ps -xfa | grep .exe" )&
(ssh -T pi5 "sudo killall new_rdout.exe"; ssh -T pi5 "nohup sudo /home/pi/RDOUT_BOARD_IPBus/rdout_software/bin/new_rdout.exe 200 2000000 0 > log.log 2>&1 &"; ssh -T pi5 "ps -xfa | grep .exe" )&
