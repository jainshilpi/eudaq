...
const size_t nSkiPerBoard[4] = {12,12,16,16};
const uint32_t skiMask[4] = {0x00000fff,0x000fff00,0x0000ffff,0x0000ffff};
// const size_t nSkiPerBoard[2] = {24,32};
// const uint32_t skiMask[2] = {0xfff0f0ff,0xffffffff};
